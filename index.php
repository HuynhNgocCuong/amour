      ...
      <div class="header_section">
         <div class="container-fluid">
            <nav class="navbar navbar-light bg-light justify-content-between">
               ...
               <a class="logo" href="index.html"><img src="images/logo1.png"></a></a>
               ...
               <div class="input-group search-bar" id="search-bar">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     <div class="row">
                        <div class="col-sm-6">
                           <h1 class="banner_taital">L'OTUS <br>Nến Thơm</h1>
                           <p class="banner_text">Nến thơm lừng số 1 FPT</p>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="row">
                        <div class="col-sm-6">
                           <h1 class="banner_taital">L'OTUS <br>Nến Thơm</h1>
                           <p class="banner_text">Thơm Lừng</p>
                           <div class="read_bt"><a href="#">Mua ngay</a></div>
                        </div>
                        <div class="col-sm-6">
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="row">
                        <div class="col-sm-6">
                           <h1 class="banner_taital">L'OTUS <br>Nến Thơm</h1>
                           <p class="banner_text">Nến thơm lừng</p>
                           <div class="read_bt"><a href="#">Mua ngay</a></div>
                        </div>
                        <div class="col-sm-6">
                           <div class="banner_img"><img src="images/nenthom4.png"></div>
                        </div>
                     </div>
                  </div>
               </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <p class="product_text">Nến thơm</p>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="product_box">
                        <h4 class="bursh_text">Beauty Brush</h4>
                        ...
                        <div class="btn_main">
                            ...
                            <h3 class="price_text">Price 50.000VND</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="product_box">
                        <h4 class="bursh_text">Nen Thom Lotus</h4>
                        <p class="lorem_text">Dựa trên kết quả từ Model, Controller quyết định trang JSP nào sẽ được sử dụng để hiển thị dữ liệu. </p>
                        ...
                        <div class="btn_main">
                            ...
                            <h3 class="price_text">Price 60.000VND</h3>
                        </div>
                    </div>
                </div>
                  <div class="col-lg-3 col-sm-6">
